...
export default function LoginPage() {
    ...
    const c = {
        page:    { minHeight:'100svh', background:'#0c0c0e', display:'flex', alignItems:'center', justifyContent:'center', padding:'16px' } as const,
        ...
        tab: (on: boolean) => ({ flex:1, textAlign:'center' as const, padding:'9px 0', borderRadius:9, fontSize:14, fontWeight:500, color: on?'#fff':'#a0a0b0', background: on?'#6366f1':'transparent', cursor:'pointer', transition:'.2s', border:'none', fontFamily:'inherit' }),
            ...
            <div style={c.wrap}>
                ...
                {step === 2 && (
                    <div>
                        ...
                        {/* 4 инпута: grid вместо flex чтобы не вылезали */}
                        <div style={{
                            display: 'grid',
                            ...
                            {otp.map((v, i) => (
                                <input
                                    ...
                                    style={{
                                        ...
                                        color: '#fff',
                                        background: '#141416',
                                        border: `1.5px solid ${v ? '#6366f1' : '#2a2a2f'}`,
                                        borderRadius: 14,
                                        outline: 'none',
                                        fontFamily: 'inherit',
                                        padding: '16px 0',
                        ...
                        <button style={c.btnOut} onClick={() => sendOtp(email)}>
                            Отправить снова
                        </button>
                    </div>
                )}
