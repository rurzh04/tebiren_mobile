              ...
              <div className="p-4 overflow-y-auto max-h-[70vh]">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm text-muted-foreground mb-1 block">{t.personalData.firstName}</label>
                      <input
                          type="text"
                    ...
                    <div>
                      <label className="text-sm text-muted-foreground mb-1 block">{t.personalData.lastName}</label>
                      <input
                          type="text"
                  ...
                  <div>
                    <label className="text-sm text-muted-foreground mb-1 block">{t.personalData.phone}</label>
                    <input
                        type="tel"
                  ...
                  <div>
                    <label className="text-sm text-muted-foreground mb-1 block">{t.personalData.company}</label>
                    <input
                        type="text"
                  ...
                  <div>
                    <label className="text-sm text-muted-foreground mb-1 block">{t.personalData.position}</label>
                    <input
                        type="text"
